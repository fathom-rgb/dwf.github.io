...
for (const file of ['spatial.css','spatial.js','styles.css','resume.css','site.js','motion.css','motion.js','identity.css','favicon.svg','unilifesim.jpg','certificate.jpg']) fs.copyFileSync(`assets/${file}`, `dist/assets/${file}`);
