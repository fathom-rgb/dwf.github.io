...
for (const file of ['styles.css','resume.css','site.js','motion.css','motion.js','identity.css','favicon.svg','photo.jpg','unilifesim.jpg','portfolio-preview.jpg','certificate.jpg']) fs.copyFileSync(`assets/${file}`, `dist/assets/${file}`);
